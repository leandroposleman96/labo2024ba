...
PARAM$semilla_primigenia <- 100049
PARAM$qsemillas <- 20
...
# itero por los loops anidados para cada hiperparametro
for (vcp in seq(-1, 0, by = 0.1)) { # ejemplo de granularidad para 'cp'
  for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
    for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
      for (vmin_bucket in c(5, 10, 20, 30, 50)) { # ejemplo de granularidad para 'minbucket'
        # definir los parámetros
        param_basicos <- list(
          "cp" = vcp, # complejidad mínima del árbol
        ...
        # Llamada a la función Monte Carlo con las semillas generadas
