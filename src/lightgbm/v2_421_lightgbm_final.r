...
PARAM$finalmodel$num_iterations <- 110
PARAM$finalmodel$learning_rate <- 0.0462343934771701
PARAM$finalmodel$feature_fraction <- 0.6113852107
PARAM$finalmodel$min_data_in_leaf <- 205
PARAM$finalmodel$num_leaves <- 164
PARAM$finalmodel$baggin_fraction <-0.287938834
PARAM$finalmodel$min_gain_to_split <-0.4309446931
PARAM$finalmodel$lambda_l2 <- 5.026760311
PARAM$finalmodel$lambda_l1 <- 0.3932076779
